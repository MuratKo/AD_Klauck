...
//		amaountOfWordsIn32000 = tbuilder.getAmountOfDifferentWords();
		...
		prog = new Programm(PATH + "test500.txt", Strategy.Q);
		prog = new Programm(PATH + "test1000.txt", Strategy.Q);
		prog = new Programm(PATH + "test2000.txt", Strategy.Q);
		prog = new Programm(PATH + "test4000.txt", Strategy.Q);
		prog = new Programm(PATH + "test8000.txt", Strategy.Q);
		prog = new Programm(PATH + "test16000.txt", Strategy.Q);
//		prog = new Programm(PATH + "test32000.txt", Strategy.Q);
