...
//		amaountOfWordsIn32000 = tbuilder.getAmountOfDifferentWords();
		...
		prog = new Programm(PATH + "test500.txt", Strategy.B);
		prog = new Programm(PATH + "test1000.txt", Strategy.B);
		prog = new Programm(PATH + "test2000.txt", Strategy.B);
		prog = new Programm(PATH + "test4000.txt", Strategy.B);
		prog = new Programm(PATH + "test8000.txt", Strategy.B);
		prog = new Programm(PATH + "test16000.txt", Strategy.B);
//		prog = new Programm(PATH + "test32000.txt", Strategy.B);
...
//			System.out.println("Anzahl der Wörter in Log-File: " + (lines - 2));
//			System.out.println("Anzahl der Wörter im text: " + amaountOfWordsIn500);
